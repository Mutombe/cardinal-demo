...
export const developmentApi = {
  dashboard: () => api.get('/development/dashboard/'),

  developers: {
    list: (params?: object) => api.get('/development/developers/', { params }),
    create: (data: object) => api.post('/development/developers/', data),
  },
  projects: {
    list: (params?: object) => api.get('/development/projects/', { params }),
    get: (id: number) => api.get(`/development/projects/${id}/`),
    create: (data: object) => api.post('/development/projects/', data),
    update: (id: number, data: object) => api.patch(`/development/projects/${id}/`, data),
    delete: (id: number) => api.delete(`/development/projects/${id}/`),
  },
  stands: {
    list: (params?: object) => api.get('/development/stands/', { params }),
    get: (id: number) => api.get(`/development/stands/${id}/`),
    create: (data: object) => api.post('/development/stands/', data),
    update: (id: number, data: object) => api.patch(`/development/stands/${id}/`, data),
    delete: (id: number) => api.delete(`/development/stands/${id}/`),
  },
  buyers: {
    list: (params?: object) => api.get('/development/buyers/', { params }),
    get: (id: number) => api.get(`/development/buyers/${id}/`),
    create: (data: object) => api.post('/development/buyers/', data),
    update: (id: number, data: object) => api.patch(`/development/buyers/${id}/`, data),
    delete: (id: number) => api.delete(`/development/buyers/${id}/`),
  },
  agencies: {
    list: (params?: object) => api.get('/development/agencies/', { params }),
    get: (id: number) => api.get(`/development/agencies/${id}/`),
    create: (data: object) => api.post('/development/agencies/', data),
    update: (id: number, data: object) => api.patch(`/development/agencies/${id}/`, data),
    delete: (id: number) => api.delete(`/development/agencies/${id}/`),
  },
  agents: {
    list: (params?: object) => api.get('/development/agents/', { params }),
    create: (data: object) => api.post('/development/agents/', data),
    update: (id: number, data: object) => api.patch(`/development/agents/${id}/`, data),
    delete: (id: number) => api.delete(`/development/agents/${id}/`),
  },
  agreements: {
    list: (params?: object) => api.get('/development/agreements/', { params }),
    get: (id: number) => api.get(`/development/agreements/${id}/`),
    create: (data: object) => api.post('/development/agreements/', data),
    update: (id: number, data: object) => api.patch(`/development/agreements/${id}/`, data),
    delete: (id: number) => api.delete(`/development/agreements/${id}/`),
    activate: (id: number) => api.post(`/development/agreements/${id}/activate/`),
    generateSchedule: (id: number) => api.post(`/development/agreements/${id}/generate_schedule/`),
  },
  ownershipProfiles: {
    create: (data: object) => api.post('/development/ownership-profiles/', data),
  },
  installments: {
    list: (params?: object) => api.get('/development/installments/', { params }),
  },
  payments: {
    list: (params?: object) => api.get('/development/payments/', { params }),
    get: (id: number) => api.get(`/development/payments/${id}/`),
    create: (data: object) => api.post('/development/payments/', data),
    delete: (id: number) => api.delete(`/development/payments/${id}/`),
  },
  inquiries: {
    list: (params?: object) => api.get('/development/inquiries/', { params }),
    get: (id: number) => api.get(`/development/inquiries/${id}/`),
    update: (id: number, data: object) => api.patch(`/development/inquiries/${id}/`, data),
    delete: (id: number) => api.delete(`/development/inquiries/${id}/`),
  },
}
