...
def generate_monthly_invoices_all_tenants():
    ...
    try:
        count = generate_monthly_invoices_for_tenant(None)
        ...
        logger.error(f"Failed to generate invoices for cardinal: {e}")
...
def repost_stuck_invoices_all_tenants():
    ...
    try:
        ...
        logger.error(f"Failed to repost stuck invoices for cardinal: {e}")
    if total:
        logger.warning(f"Self-healed {total} stuck DRAFT invoice(s)")
...
def mark_overdue_invoices_all_tenants():
    ...
    try:
        ...
        logger.error(f"Failed to mark overdue for cardinal: {e}")
...
def send_rental_due_reminders_all_tenants():
    ...
    try:
        ...
        logger.error(f"Failed to send due reminders for cardinal: {e}")

    logger.info(f"Sent {total_reminders} rental due reminders")
...
def apply_late_penalties_all_tenants():
    ...
    try:
        ...
        logger.error(f"Failed to apply penalties for cardinal: {e}")

    logger.info(f"Applied {total_penalties} late penalties")
