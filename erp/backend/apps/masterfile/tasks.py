...
def send_lease_expiry_reminders():
    ...
    try:
        ...
        logger.error(f"Failed to check leases for cardinal: {e}")
...
def send_landlord_monthly_reports_all_tenants():
    ...
    try:
        ...
        logger.error(f"Failed to send landlord reports for cardinal: {e}")

    logger.info(f"Sent {total_reports} landlord monthly reports")
