...
def _run_report_for_all_tenants(report_name, generate_fn, build_body_fn, subject_template):
    ...
    try:
        ...
        results['success'].append('cardinal')
    except Exception as e:
        logger.error(f"[{report_name}] Failed for cardinal: {e}")
        results['failed'].append({'tenant': 'cardinal', 'error': str(e)})
...
def send_monthly_commission_reports_all_tenants():
    ...
    try:
        ...
        logger.error(f"Failed to send commission report for cardinal: {e}")
